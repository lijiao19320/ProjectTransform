...
class FY3AVirrProvider(DataProvider):
    ...
    def Dispose(self):
        ...
        #del self.__filehandle
        #self.__HdfFileHandleList['L1'].close()
        ...
        self.__description = 'NULL'
        self.__obsDataCount = 0
        super(FY3AVirrProvider, self).Dispose()


    def __InitOrbitInfo(self):
        #self.OrbitInfo.Sat = 'FY-3A'
    ...
    def OnParametersUpdate(self):
        super(FY3AVirrProvider, self).OnParametersUpdate()
    ...
    def SetLonLatFile(self,latfile,lonfile):
        ...
        self.__HdfFileHandleList['L1'] = self.__HdfOperator.Open(latfile)
        self.__HdfFileHandleList['L1'] = self.__HdfOperator.Open(lonfile)
    ...
    #     return self.GetDataSet(self.__filehandle, '/', 'SensorAzimuth')
    #
    # def GetSensorZenith(self):
    #     return self.GetDataSet(self.__filehandle, '/', 'SensorZenith')
    #
    # def GetSolarAzimuth(self):
    #     return self.GetDataSet(self.__filehandle, '/', 'SolarAzimuth')
    #
    # def GetSolarZenith(self):
    #     return self.GetDataSet(self.__filehandle, '/', 'SolarZenith')
    ...
    def GetOBSData(self, band):
        ...
        if self.__RefData == None:
            if band in bandRef:
                self.__RefData = self.GetDataSet(self.__HdfFileHandleList['L1'], '/', 'EV_RefSB')
            else:
                self.__RefData = self.GetDataSet(self.__HdfFileHandleList['L1'], '/', 'EV_Emissive')
    ...
    def SetAuxiliaryDataFile(self, LNDfile, LMKfile, DEMfile, COASTfile, SATZENfile, SATAZIfile, Lonfile, LatFile):
        ...
        if DEMfile != 'NULL':
            ...
            #self.__AuxiliaryDataNamesList['DEM'] = 'NULL'
        if COASTfile != 'NULL':
    ...
    def GetAuxiliaryData(self,dataname):
        ...
        ret=self.GetDataSet(self.__HdfFileHandleList['L1'], '/', dsname)
